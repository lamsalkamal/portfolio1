...
if (strlen($_SESSION['alogin'])==0) {
    ...
    $_SESSION['msgclass']="";
    if (isset($_GET['del'])) {
        $delQuery = mysqli_query($conn, "delete from about where id = '".$_GET['id']."'");
        if ($delQuery) {
            echo "<script>document.location = 'manage-about.php';</script>";
            $_SESSION['delmsg']="About deleted !!";
...
<div class="container body-section">
    <div class="row">
        ...
        <div class="next-col col-md-9">
            <h5 class="form-head">Manage About</h5>
            <hr />
                ...
                <table cellpadding="0" cellspacing="0" border="0"
                    ...
                    <thead>
                        <tr>
                            ...
                            <th>Description</th>
                            <th>Image</th>
                            <th>About Creation Date</th>
                            <th>Last Updated Date</th>
                            <th>Action</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php $query=mysqli_query($conn, "select * from about");
                            $cnt=1;
                        ...
                        ?>
                            <tr>
                                ...
                                <td><img src="../uploads/about-image/<?php echo htmlentities($row['image']); ?>"
                                ...
                                <td>
                                    <a href="edit-about.php?id=<?php echo $row['id']?>&location=about"><i class="fa fa-edit"></i></a>
                                    <a href="manage-about.php?id=<?php echo $row['id']?>&del=delete"
