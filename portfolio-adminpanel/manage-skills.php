...
if (strlen($_SESSION['alogin'])==0) {
    ...
    $_SESSION['msgclass']="";
    if (isset($_GET['del'])) {
        $delQuery = mysqli_query($conn, "delete from skills where id = '".$_GET['id']."'");
        if ($delQuery) {
            echo "<script>document.location = 'manage-skills.php';</script>";
            $_SESSION['delmsg']="Skills deleted !!";
            $_SESSION['msgclass']="error-msg";
        }
    } ?>

<?php   
    $pageTitle = 'Manage Skills Section';
...
<div class="container body-section">
    <div class="row">
        ...
        <div class="next-col col-md-9">
            <h5 class="form-head">Manage Skills</h5>
            <hr />
            <div class="manage-job">
                ...
                <table cellpadding="0" cellspacing="0" border="0"
                    ...
                    <tbody>
                        <?php $query=mysqli_query($conn, "select * from skills");
                            $cnt=1;
                        ...
                        ?>
                            <tr>
                                ...
                                <td><img src="../uploads/skills-image/<?php echo htmlentities($row['image']); ?>"
                                ...
                                <td>
                                    ...
                                    <a href="manage-skills.php?id=<?php echo $row['id']?>&del=delete"
